...
from data_prep import CodePreprocess
...
class CodeIdentify:
    ...
    def __init__(self, model_file=os.path.join(THIS_FOLDER,'ft.li.1701.bin'),
                 code2namefile=os.path.join(THIS_FOLDER,'lang_code.json')):
        self.model = ft.load_model(model_file)
        self.code2name = rev_dict(json.load(open(code2namefile)))
